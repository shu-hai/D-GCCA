...
# Use user-specified ranks of the Xk matrices (e.g., from the scree plot) 
# Xk_hat, Ck_hat, Dk_hat, PVE_by_Ck_SetLevel_hat,  PVE_by_Ck_VariableLevel_hat  = dgcca.dGCCA(Yk, rankX=[5,5,5], sig_level=0.05, bootstrap_samples=10000)
